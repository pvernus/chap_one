...
data_channel |> 
  mutate(channel_multin = case_when(
    channel_parent_code_2024 < 20000 ~ "Public sector",
    channel_parent_code_2024 %in% c(20000:23000) ~ "NGOs and Civil society",
    channel_parent_code_2024 %in% c(40000:47000) ~ "Multilaterals",
    channel_parent_code_2024 %in% c(60000:63000) ~ "Private sector",
    .default = "Other"
  ))
