...
# select variables
data_select <- select(data_crs_import, 1, 2:4, 5:6, 7:8, 9, 10:12, 13:15, 16:18, 19:24, 28:29, 50, 49, 64, 51:54, 55:58, 68, 79:82)
```
...
# create variable
data_channel_state <- data_channel_code |> 
  mutate(
...
# save
save(data_iso3c,
     file = "C:\\Users\\pauvernu\\Seafile\\library\\chap_one_data\\data\\outcome\\data_iso3c.RData")

# list donor, recipient, and year list
data_unit_outcome <- data_crs |> 
...
# save
save(data_unit_outcome,
     file = "C:\\Users\\pauvernu\\Seafile\\library\\chap_one_data\\data\\outcome\\data_unit_outcome.RData")
