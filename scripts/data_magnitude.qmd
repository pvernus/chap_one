...
# save
save(data_wet, data_dry, data_hot, data_wind,
...
# create list
clim_list <- list(data_wet, data_dry, data_hot, data_wind)
# combine list elements
clim_data <- do.call(rbind, clim_list)
...
load(file = "C:\\Users\\pauvernu\\Seafile\\library\\chap_one_data\\data\\treatment\\gdis\\data_gdis.RData") # GDIS
```
