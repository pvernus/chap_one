...
# Single treatments of identical intensities (first-treatment-and-staggerize)
...
df <- select(data_first, iso3c, year, starts_with("first_treat_dis")) |> 
  pivot_longer(cols = -c(iso3c, year), names_to = "dis", values_to = "treat")
